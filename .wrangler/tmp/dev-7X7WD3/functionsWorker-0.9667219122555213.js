// .wrangler/tmp/bundle-L3cN0R/checked-fetch.js
...
// .wrangler/tmp/pages-UwzsqI/functionsWorker-0.9667219122555213.mjs
...
function composeRequest(formData, env) {
  ...
  return {
    ...
    content: [
      {
        type: "text/plain",
        value: `New message from ${name} (${email}):\r
\r
 "${message}"`
      }
    ],
...
async function sendEmail(composedRequest, env) {
  let emailResponse = void 0;
  try {
...
var routes = [
  {
    routePath: "/api/sendContactEmail",
    mountPath: "/api",
    method: "POST",
    middlewares: [],
...
// .wrangler/tmp/bundle-L3cN0R/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-L3cN0R/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.9667219122555213.js.map
